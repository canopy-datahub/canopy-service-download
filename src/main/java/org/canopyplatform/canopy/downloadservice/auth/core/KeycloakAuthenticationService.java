package org.canopyplatform.canopy.downloadservice.auth.core;

import org.canopyplatform.canopy.downloadservice.auth.AuthCapability;
import org.canopyplatform.canopy.downloadservice.auth.UserAuthenticationException;
...
import org.canopyplatform.canopy.downloadservice.auth.AuthLookupStatusRepository;
...
import org.canopyplatform.canopy.downloadservice.auth.AuthUserRepository;
 ...
 *     Integer userId = authenticationService.checkCapability(jwt, "study.uuids.export");
 *     // ... admin only logic
 * }
 * }
 * </pre>
