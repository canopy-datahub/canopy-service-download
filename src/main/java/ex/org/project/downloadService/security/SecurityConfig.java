package ex.org.project.downloadService.security;
...
/**
 * Security configuration for Download Service.
 * 
...
public class SecurityConfig {
  ...
  public SecurityFilterChain actuatorSecurityFilterChain(HttpSecurity http) throws Exception {
    http
        .securityMatcher("/api/download/v1/actuator/**")  // Match actuator path explicitly
        .authorizeHttpRequests(auth -> auth
            .requestMatchers("/api/download/v1/actuator/health").permitAll()
            .requestMatchers("/api/download/v1/actuator/shutdown").authenticated()
            .anyRequest().authenticated()
        )
        .csrf(csrf -> csrf
            .ignoringRequestMatchers("/api/download/v1/actuator/shutdown")
        )
  ...
  public SecurityFilterChain apiSecurityFilterChain(HttpSecurity http) throws Exception {
    http
        ...
        .securityMatcher(request -> !request.getRequestURI().startsWith("/api/download/v1/actuator"))
